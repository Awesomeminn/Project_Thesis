# 데이터 불러오기
import pandas as pd
df = pd.read_csv('C:/Users/Awesomemin/Desktop/연구아카이브/Project_Thesis/연습장/소비지출전망/model1/data2.csv')
df.set_index('Date', inplace=True)
df
#==========================================================================================================#
# 시차 상관분석 실시
## 분석에 사용할 변수 설정
x = df['durable_consume_exp_CSI_lndiff']       
y_candidates = [col for col in df.columns if col != 'durable_consume_exp_CSI_lndiff'] 
## 시차 범위 설정
lags = range(-3, 4)
result = {}
